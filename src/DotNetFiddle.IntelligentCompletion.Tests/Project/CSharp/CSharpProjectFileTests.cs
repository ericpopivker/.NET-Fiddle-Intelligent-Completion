...
namespace DotNetFiddle.IntelligentCompletion.Tests.Project
{
    ...
    public class CSharpProjectFileTests
    {
        ...
        public void Project_Works()
        {
            ...
            currentPath = Path.Combine(currentPath, "Samples", "CSharp");

            string dogMainPath = Path.Combine(currentPath, "DogMain.cs");
            string dogPath = Path.Combine(currentPath, "DogOneProperty.cs");
        ...
        public void Project_Changed_Works()
        {
            ...
            string dogMainPath = Path.Combine(currentPath, "DogMain.cs");
            string dogPath = Path.Combine(currentPath, "DogOneProperty.cs");
            string dogNewPath = Path.Combine(currentPath, "DogTwoProperties.cs");
